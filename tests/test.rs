...
fn err_expression_broken_multiline_comment_b() {
    assert_eq!(
        compile("{/*x}", &Default::default())
            ...
            .unwrap()
            .to_string(),
        "1:2: Could not parse expression with swc: Expression expected (mdxjs-rs:swc)",
...
fn err_expression_invalid() {
    assert_eq!(
        compile("{!}", &Default::default())
            ...
            .unwrap()
            .to_string(),
        "1:4: Could not parse expression with swc: Expression expected (mdxjs-rs:swc)",
...
fn err_expression_value_empty() {
    assert_eq!(
        compile("<a b={ } />", &Default::default())
            ...
            .unwrap()
            .to_string(),
        "1:7: Could not parse expression with swc: Expression expected (mdxjs-rs:swc)",
